...
function App() {
  ...
  const barChartOptions = {
    ...
    subtitle: {
      useHTML: true,
      text:
        '<span style="font-weight: bold; font-size:24px">£714m </span>' +
  ...
  const barBasicChartOptions = {
    ...
    tooltip: {
      headerFormat: '<span style="font-size:10px">{point.key}</span><table>',
      pointFormat:
        '<tr><td style="color:{series.color};padding:0">{series.name}: </td><td style="padding:0"><b>{point.y:.1f} m</b></td></tr>',
      footerFormat: "</table>",
      shared: true,
      useHTML: true,
    },
  ...
  return (
    <>
      ...
      <div>
        <HighchartsReact highcharts={Highcharts} options={columnStacked} />
      </div>
      ...
      <div>
        <HighchartsReact highcharts={Highcharts} options={dualChartOptions} />
      </div>
      <br />
      <br />
      <br />
